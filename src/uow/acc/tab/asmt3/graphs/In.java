...
public final class In {
   ...
   /**
    ...
    public static void main(String[] args) {
        In in;
        String urlName = "http://introcs.cs.princeton.edu/stdlib/InTest.recourse";
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new In("../stdlib/InTest.recourse");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        in = new In("/n/fs/introcs/www/java/stdlib/InTest.recourse");
        try {
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new In("G:\\www\\introcs\\stdlib\\InTest.recourse");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
