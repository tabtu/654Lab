package uow.acc.tab.asmt3.graphs;

/*************************************************************************
 *  Compilation:  javac SymbolGraph.java
 *  Execution:    java SymbolGraph filename.recourse delimiter
 ...
 *  
 *  %  java SymbolGraph routes.recourse " "
 *  JFK
 *     MCO
 *     ATL
 *     ORD
 ...
 *     LAS
 *
 *  % java SymbolGraph movies.recourse "/"
 *  Tin Men (1987)
 *     Hershey, Barbara
 *     Geppi, Cindy
 *     Jones, Kathy (II)
 ...
 *  % iconv -f ISO-8859-1 -t UTF-8 movies-iso8859.recourse > movies.recourse
 *
 *************************************************************************/
...
public class SymbolGraph {
    ...
    public static void main(String[] args) {
        ...
        SymbolGraph sg = new SymbolGraph("document/Assignment3/data/movies.txt", "/");
        Graph G = sg.G();
