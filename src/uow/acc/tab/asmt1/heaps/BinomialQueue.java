package uow.acc.tab.asmt1.heaps;
...
/**
* Find index of algs containing the smallest item in the priority queue.
* The priority queue must not be empty.
* @return the index of algs containing the smallest item.
*/
...
private BinNode<AnyType> [ ] theTrees;  // An array of algs roots
