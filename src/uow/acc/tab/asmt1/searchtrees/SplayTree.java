...
/**
* Implements a top-down splay algs.
...
public class SplayTree<AnyType extends Comparable<? super AnyType>>
{
  ...
  *     smaller than any item in the algs, then call findMin.
  ...
  *     amortized behavior.
  * A good alternative is to first call find with parameter
  *     larger than any item in the algs, then call findMax.
