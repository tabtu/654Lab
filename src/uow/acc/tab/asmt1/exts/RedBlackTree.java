...
public class RedBlackTree<E> implements Set<E> {
  ...
  /* node insert methods */
    ...
    /**
     * Adds a node into the algs using the comparator
     *
  ...
  /* node lookup methods */
    ...
    /**
     * Binary search method that looks for a particular node in the algs using comparator
     *
     * @param node
     * @param element
    ...
    /**
     * Rebalance the algs until all properties are fullfilled
     *
  ...
  /* transformation methods */
    ...
    /**
     * Replaces a node in the algs with the given child
    ...
    /**
     * private Iterator class that traverses the algs in order
     * TODO: need to fix Queue approach because it doesn't reflect the order of the algs
     * @author christian
     */
    private final class Itr implements Iterator<E> {

        /* Used to verify if the algs has been modified during iteration */
        ...
        public void remove() {
            ...
            /* expected mount count in algs will change so it needs to be changed here */
