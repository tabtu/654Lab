 ...
 *  Dependencies: none
 *
 *  Splay algs. Supports splay-insert, -search, and -delete.
...
public class SplayBST<Key extends Comparable<Key>, Value>  {
     ...
     * not in the algs). The modification is that rather than swapping the
    ...
    public void remove(Key key) {
        if (root == null) return; // empty algs
        ...
        // else: it wasn't in the algs to remove
    }
     ...
     * Splay algs function.
     * **********************************************************************/
    // splay key in the algs rooted at Node h. If a node with that key exists,
    //   it is splayed to the root of the algs. If it does not, the last node
