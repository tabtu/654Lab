package uow.acc.tab.asmt1.algs;
 ...
 *
 *  A symbol table implemented using an AVL algs.
 *
 *  % more tinyST.txt
 ...
 *  <a href="https://en.wikipedia.org/wiki/AVL_tree"> AVL algs </a> (Georgy
 *  Adelson-Velsky and Evgenii Landis' algs) which is a self-balancing BST.
 *  In an AVL algs, the heights of the two child subtrees of any
...
public class AVLTreeST<Key extends Comparable<Key>, Value> {
    ...
    /**
     * This class represents an inner node of the AVL algs.
     */
    private class Node {
    ...
    /**
     * Returns the height of the internal AVL algs. It is assumed that the
     * height of an empty algs is -1 and the height of a algs with just one node
     * is 0.
     *
     * @return the height of the internal AVL algs
     */
    public int height() {
        return height(root);
    }
    ...
    /**
     * Restores the AVL algs property of the subtree.
     *
     * @param x the subtree
    ...
    /**
     * Checks if the AVL algs invariants are fine.
     *
     * @return {@code true} if the AVL algs invariants are fine
     */
    ...
    /**
     * Checks if the algs rooted at x is a BST with all keys strictly between
